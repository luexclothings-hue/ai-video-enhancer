...
class TensorRTStableDiffusionImg2ImgPipeline(DiffusionPipeline):
    ...
    def __denoise_latent(
        self, image, latents, text_embeddings, timesteps=None, step_offset=0
    ):
    ...
    def __call__(
        ...
        with torch.inference_mode(), torch.autocast("cuda"), trt.Runtime(TRT_LOGGER):
            ...
            for num_image, data in enumerate(init_images): 
                ...
                # UNet denoiser
                latents[num_image] = self.__denoise_latent(image, latents[num_image], text_embeddings, timesteps=timesteps, step_offset=t_start)
