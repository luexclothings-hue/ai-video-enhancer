...
class UNet(BaseModel):
    ...
    def get_shape_dict(self, batch_size, image_height, image_width):
        ...
        return {
            ...
            #     "block_0": (2 * batch_size, 256, 180, 320),
            #     "block_1": (2 * batch_size, 256, 180, 320),
            #     "block_2": (2 * batch_size, 256, 180, 320),
            #     "block_3": (2 * batch_size, 256, 90, 160),
            #     "block_4": (2 * batch_size, 512, 90, 160),
            #     "block_5": (2 * batch_size, 512, 90, 160),
            #     "block_6": (2 * batch_size, 512, 45, 80),
            #     "block_7": (2 * batch_size, 512, 45, 80),
            #     "block_8": (2 * batch_size, 512, 45, 80),
            #     "block_9": (2 * batch_size, 512, 23, 40),
            #     "block_10": (2 * batch_size, 1024, 23, 40),
            #     "block_11": (2 * batch_size, 1024, 23, 40)
            # },
...
class ControlNet(BaseModel):
    ...
    def get_dynamic_axes(self):
        return {
            ...
            #     "block_0": [
            #         (2 * batch_size, 256, 180, 320),
            #         (2 * batch_size, 256, 180, 320),
            #         (2 * batch_size, 256, 180, 320)
            #     ],
            #     "block_1": [
            #         (2 * batch_size, 256, 90, 160),
            #         (2 * batch_size, 512, 90, 160),
            #         (2 * batch_size, 512, 90, 160)
            #     ],
            #     "block_2": [
            #         (2 * batch_size, 512, 45, 80),
            #         (2 * batch_size, 512, 45, 80),
            #         (2 * batch_size, 512, 45, 80)
            #     ],
            #     "block_3": [
            #         (2 * batch_size, 512, 23, 40),
            #         (2 * batch_size, 1024, 23, 40),
            #         (2 * batch_size, 1024, 23, 40)
            #     ]
            # },
    ...
    def get_shape_dict(self, batch_size, image_height, image_width):
        ...
        return {
            ...
            # "down_block_res_samples": {
            #     "block_0": {0: "1B", 1: 256, 2: 180, 3: 320},
            #     "block_1": {0: "1B", 1: 256, 2: 180, 3: 320},
            #     "block_2": {0: "1B", 1: 256, 2: 180, 3: 320},
            #     "block_3": {0: "1B", 1: 256, 2: 90, 3: 160},
            #     "block_4": {0: "1B", 1: 512, 2: 90, 3: 160},
            #     "block_5": {0: "1B", 1: 512, 2: 90, 3: 160},
            #     "block_6": {0: "1B", 1: 512, 2: 45, 3: 80},
            #     "block_7": {0: "1B", 1: 512, 2: 45, 3: 80},
            #     "block_8": {0: "1B", 1: 512, 2: 45, 3: 80},
            #     "block_9": {0: "1B", 1: 512, 2: 23, 3: 40},
            #     "block_10": {0: "1B", 1: 1024, 2: 23, 3: 40},
            #     "block_11": {0: "1B", 1: 1024, 2: 23, 3: 40}
            # },
            # "mid_block_res_sample": (2 * batch_size, 1024, 23, 40)
        }
...
class TensorRTStableDiffusionImg2ImgPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        stages=["clip", "UNet2DConditionControlNet", "vae", "vae_encoder"],
    ...
    def __call__(
        ...
        with torch.inference_mode(), torch.autocast("cuda"), trt.Runtime(TRT_LOGGER):
            ...
            init_images =  [self.image_processor.preprocess(image, height=180, width=320).to(dtype=torch.float32).to(self.torch_device) for image in images]
            ...
            for num_image, data in enumerate(init_images): 
                ...
                # UNet denoiser
                latents[num_image] = self.__denoise_latent(image, latents[num_image], warped_prev_est, text_embeddings, timesteps=timesteps, step_offset=t_start)
